...
const create = catchError(async (req, res) => {
  ...
  await sendEmail({
    to: "germanymnlr784@gmail.com",
    subject: "Verificate email for user app",
    html: `
        <h1> ${firstName} ${lastName} </h1>
        <p> Thanks you for sign up app </p>
        <img src='https://randomuser.me/api/portraits/lego/6.jpg'> </img>
        <b> Verify your acount clicking this link </b>
        <a href="${link}">${link} </a>
        <h3> Thank you </h3>
    `,
  });
